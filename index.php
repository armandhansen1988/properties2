    ...
    case "properties":
        switch ($url[1]) {
            ...
            case "singleview":
                ...
                $county = $Functions->sanatizeDisplay($getProperty['county']);
                $country = $Functions->sanatizeDisplay($getProperty['country']);
                $town = $Functions->sanatizeDisplay($getProperty['town']);
                $description = $Functions->sanatizeDisplay($getProperty['description']);
                $image_url = $Functions->sanatizeDisplay($getProperty['image_url']);
                $latitude = $Functions->sanatizeDisplay($getProperty['latitude']);
                $longitude = $Functions->sanatizeDisplay($getProperty['longitude']);
                $num_bedrooms = $Functions->sanatizeDisplay($getProperty['num_bedrooms']);
                $num_bathrooms = $Functions->sanatizeDisplay($getProperty['num_bathrooms']);
                $price = $Functions->sanatizeDisplay($getProperty['price']);
                $property_type_id = $Functions->sanatizeDisplay($getProperty['property_type_id']);
                $sale_type = $Functions->sanatizeDisplay($getProperty['sale_type']);
                
                $proptype = DBC::dbsql("SELECT * FROM property_type WHERE id = '$property_type_id';");
                $getPropType = DBC::dbfetch($proptype);
                $property_type_title = $Functions->sanatizeDisplay($getPropType['title']);
                $property_type_description = $Functions->sanatizeDisplay($getPropType['description']);
            ...
            case "edit":
                ...
                $country = $Functions->sanatizeDisplay($getProperty['country']);
                $town = $Functions->sanatizeDisplay($getProperty['town']);
                $postcode = $Functions->sanatizeDisplay($getProperty['postcode']);
                $displayable_address = $Functions->sanatizeDisplay($getProperty['displayable_address']);
                $description = $Functions->sanatizeDisplay($getProperty['description']);
                $image_url = $Functions->sanatizeDisplay($getProperty['image_url']);
                $thumbnail_url = $Functions->sanatizeDisplay($getProperty['thumbnail_url']);
                $latitude = $Functions->sanatizeDisplay($getProperty['latitude']);
                $longitude = $Functions->sanatizeDisplay($getProperty['longitude']);
                $num_bedrooms = $Functions->sanatizeDisplay($getProperty['num_bedrooms']);
                $num_bathrooms = $Functions->sanatizeDisplay($getProperty['num_bathrooms']);
